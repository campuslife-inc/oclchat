...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'xxxxx';                     // Here enter your SMTP Username
            $mail->Password   = 'xxxxx';					//Here enter your SMTP Password
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost/ratchet-chat-application-source-code/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
