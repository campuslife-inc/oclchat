...
class ChatUser
{
	...
	{
		$query="select user_id, user_name,user_profile, user_login_status,(select count(*) from chat_message where to_user_id = :user_id and from_user_id = 
		chat_user_table.user_id and status = 'No') as count_status from chat_user_table";
		$statement = $this->connect->prepare($query);
